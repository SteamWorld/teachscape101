	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
                ...
                <li><g:link class="list" controller="contact" action="printExpiredContacts">Expired Contacts</g:link></li>

                <li><g:link class="list" action="reset"><g:message code="default.reset.label" args="[entityName]" /></g:link></li>
			...
			<table>
				<thead>
					<tr>
                        ...
                        <g:sortableColumn property="assistantOrganizer" title="${message(code: 'contact.assistantOrganizer.label', default: 'Assistant Organizer')}" />
                        <!--
                        <g:sortableColumn property="url" title="${message(code: 'contact.url.label', default: 'Url')}" />
                        -->
