...
class ContactControllerTests {
    ...
    def populateValidParams(params) {
        ...
        params["joinedGroupOn"] = new Date()
        params["lastVisitedGroupOn"] = new Date()
        params["lastAttended"] = new Date()
        params["rsvpCount"] = 5
        params["rsvpYes"] = 5
        params["rsvpMaybe"] = 5
        params["rsvpNo"] = 5
        params["meetupsAttended"] = 5
        params["noShows"] = 5
        params["intro"] = "Yes"
        params["photo"] = "Yes"
        params["assistantOrganizer"] = "Yes"
        params["mailingList"] = "Yes"
